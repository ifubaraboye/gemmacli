...
import type { ManualTool, NextTurnParamsFunctions, ServerTool, ServerToolConfig, ServerToolType, ToModelOutputFunction, Tool, ToolApprovalCheck, ToolExecuteContext, ToolWithExecute, ToolWithGenerator } from './tool-types.js';
/**
